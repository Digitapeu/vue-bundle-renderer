...
const defaultShouldPrefetch = (resource: ResourceMeta) => false // resource.resourceType !== 'font'
const defaultShouldPreload = (resource: ResourceMeta) => false //['module', 'script', 'style'].includes(resource.resourceType || '')
