...
const defaultShouldPrefetch = (resource: ResourceMeta) => resource && resource.resourceType !== 'font'
const defaultShouldPreload = (resource: ResourceMeta) => resource && ['module', 'script', 'style'].includes(resource.resourceType || '')
